...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
        <a id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i>添加权限</a>
        <a href="javascript:ovid()" class="btn btn-danger"><i class="fa fa-trash"></i>批量删除</a>
       </span>
       <span class="r_f"></span>
     </div>
     <div class="compete_list">
       <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_table">
		 <thead>
			<tr>
             ...
             <tbody>
             <c:forEach items="${module}" var="item" varStatus="vs">
			  <tr>
...
--%>
 <!--添加权限-->
 <div id="Competence_add_style" class="add_menber" style="display:none">

	 <form name="addModuleForm" method="post" id="form-admin-add" style="padding-top: 20px;">
		 <div class="form-group">
			 <label class="form-label"><span class="c-red">*</span>权限名称：</label>
			 <div class="formControls">
				 <input type="text" class="input-text" value="" placeholder="" id="mod_name" name="mod_name" datatype="*2-16" nullmsg="权限名称不能为空">
			 </div>
		 ...
		 <div class="form-group">
			 ...
			 <div class="formControls">
				 <input type="text" placeholder="URL" name="url" id="url" autocomplete="off" value="" class="input-text" datatype="*6-20" nullmsg="URL不能为空">
			 </div>
			 <div class="col-4"> <span class="Validform_checktip"></span></div>
		 </div>
		 <div class="form-group">
			 ...
			 <div class="formControls "> <span class="select-box" style="width:150px;">
				&nbsp;&nbsp;<select class="select" name="pid" size="1" id="module">
...
<script type="text/javascript">
	...
	$(function(){
		//查询分类
		$.ajax({
			url:'${pageContext.request.contextPath}/permission/selectMainModule',
			type:'POST',
			success:function (val) {

				for(var i=0;i < val.length; i++){
					$("#module").append("<option value="+val[i].id+">"+val[i].mod_name+"</option>");
				}
 ...
 $('#Competence_add').on('click', function(){
     ...
     $(".col-sm-9 input[type$='text'],#form_textarea").each(function(n){
		  ...
		  if(num>0){  return false;}
			  ...
			  $.ajax({
				  url:'${pageContext.request.contextPath}/permission/insertModule',
				  type:'post',
				  data:$("form[name='addModuleForm']").serializeArray(),
				  success:function(val){
                      if(val.code == 1){
						  layer.alert(val.data,{
						   ...
						   layer.close(index);
						  window.location.href="${pageContext.request.contextPath}/permission/selectAllModule";
					  }
					  if(val.code == 2){
						  layer.alert(val.data,{
							  title: '提示框',
...
function editPermission(id){
	window.location.href="${pageContext.request.contextPath}/permission/showPermissionPage?id="+id;
}
...
function Competence_del(id){
		window.location.href ="${pageContext.request.contextPath}/Competence.html";
};
/*字数限制*/
