...
<body>
 ...
 <div id="body" style="background:none;margin-bottom: 120px;">
      <div class="subbanner" style="background:url(images/aboutbgbg.jpg) top center repeat-x">
        <div class="subbannercontent" style=" width:100%; background:url(images/aboutbg.jpg) top center no-repeat">
          <div class="subbody" style="padding-top:31px;">
            <div class="subbodyleft">
              <ul>
                <li class="firstli">新闻中心</li>
                  <li><a href="">行业新闻</a></li><li><a href="">公司新闻</a></li>
              </ul>
              <div class="follows"></div>
            </div>
            <div class="subbodyright">
              <div class="location" style="line-height:30px;"><a href="http://www.51taorui.com">首页</a> - <a href="">新闻中心</a> - 行业新闻</div>
              <h2>NEWS</h2>
              <div class="bigclass">行业新闻</div>


              <div class="newslist bigclass">
              <div id="post-249" class="post-249 post type-post status-publish format-standard hentry category-sbm-news">
              <h3><span style="float:left;font-family:微软雅黑;font-size:15px"><a href="newsview.html">全球互联网产业研究之</a></span>.
                  <span style="float:right">2016-05-14</span>
              </h3>
              <p class="content" style="color:gray">今年以来，陆续上线的原创音乐市场成外界关注的焦点，无论是唱片公司还是在线音乐平台，纷纷发布了原创音乐交易平台。<a href="newsview.html" class="more">查看详细</a>
              </p>
              </div>
              <div class="clear"></div>
              </div>
